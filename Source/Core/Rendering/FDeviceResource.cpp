	...
	{
		{
			...
			FStaticMeshCreator::CreateMesh("Low-Poly Plant_.obj", "Plant2");
			FStaticMeshCreator::CreateMesh("MER.obj", "Rober_MER22");
		...
		{
			FStaticMesh* StaticMeshAsset = ObjReader::Read("MER.obj");
			FString MeshName = TEXT("Rober_MER");
			StaticMeshAsset->Name = MeshName;
			FVertexBuffer::Create(MeshName, StaticMeshAsset->Vertices);
